...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        SFT_T(KC_GRV), CTL_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,               LCAG_T(KC_LBRC),      KC_RBRC, KC_N,               KC_M,    KC_COMM,   KC_DOT,    CTL_T(KC_SLSH),       KC_RSFT,
                                                         KC_LGUI, LT(_LOWER, KC_SPC), KC_SPC,               KC_ENT,  LT(_RAISE, KC_ENT), KC_LALT
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,        _______,        _______, _______, KC_DOWN, KC_LCBR, KC_LPRN,          KC_RPRN, KC_RCBR, KC_P1,   KC_P2,   KC_P3,   KC_MINS,              _______,
                                                          _______, LOWER,   _______,          KC_DEL,  RAISE,   KC_P0
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        _______,        _______,        _______, _______, KC_PGDN, KC_MINS, KC_LPRN,          KC_RPRN, KC_PLUS, KC_END,  _______, _______, _______,              _______,
                                                          _______, LOWER,   KC_DEL,           _______, RAISE,   _______
    ),
